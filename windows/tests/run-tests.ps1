...
try {
  ...
  foreach ($requiredCss in @(
    ...
    ':is(main.main-surface, .app-shell-main-content-viewport) > header.app-header-tint',
    ...
    ':is(main.main-surface, .app-shell-main-content-viewport):has([role="main"])',
    ':is(main.main-surface, .app-shell-main-content-viewport):not(:has([role="main"]))'
  )) {
