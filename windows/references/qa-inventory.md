...
- Tray lifecycle: pause/resume reflects the clicked state, bundled Romantic Rose theme is present on first install, and complete restore terminates any separately launched tray before it can reapply the skin.
